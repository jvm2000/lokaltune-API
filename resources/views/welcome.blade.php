            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <div class="flex items-center gap-4">
                        ...
                        <p class="mt-6 text-4xl font-semibold text-gray-900 dark:text-white">Laravel Sanctum</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Thank you for installing. (Docker is required.)</h2>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    This repository implements Laravel Sanctum utilizing a Docker server. I extend my appreciation to Laravel Co. for the contributions of packages and dependencies employed in this project.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sm:flex grid justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    <div class="text-center sm:flex hidden text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                        <div class="flex items-center gap-4">
                            <a href="https://www.facebook.com/mromvak" class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 ">
                                <div class="flex items-center gap-4">
                                    <img src="/icons/fb.svg" alt="">
                                </div>
                            </a>

                            <a href="https://twitter.com/Ombik17" class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 ">
                                <div class="flex items-center gap-4">
                                    <img src="/icons/twitter.svg" alt="">
                                </div>
                            </a>

                            <a href="https://www.instagram.com/partidakiddo" class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 ">
                                <div class="flex items-center gap-4">
